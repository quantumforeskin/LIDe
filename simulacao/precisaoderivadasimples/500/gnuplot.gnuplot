...
set output "initialcondition_500.png"
plot "evolution3_500.run" u 2:($1==0?$7:1/0), f(x)

set output "metodo1a_500.png"
plot "evolution3_500.run" u 2:($1==1?$4:1/0), g(x)

set output "metodo2a_500.png"
